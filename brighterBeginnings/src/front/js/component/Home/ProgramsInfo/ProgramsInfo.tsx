...
const ProgramsInfo = () => {
  ...
  //     // Clean up the timer on component unmount or when isClicked changes
  ...
  return (
    <>
    <div className={` ${!isClicked ? "d-block":"d-none"} p-md-5 p-0 container m-md-6 m-5 mx-auto`}>
        ...
        <div className={` ${!isClicked ? "d-none":"d-block"} p-md-5 p-2 container ${!fade ? "opacity-low" : "opacity-high"} find-program-container `}
        >
      ...
      {/* {!isClicked ? (
        ...
        <div className={`p-md-5 p-2 container opacity-high find-program-container `}
        // ${!fade ? "opacity-low" : "opacity-high"}
        style={{opacity:0.25 }}
        >
          <div className="w-100 mt-md-0 mt-5">
            <div className="title-container mt-md-0 mt-3 w-100 mx-auto text-center">
