  ...
  return (
    <div className="footer-container bg-light w-100 pt-2">
      <div className="d-flex text-center container">
        <div className="col-3 border-3 border-end px-1">
          <span className="fa fa-phone my-auto p-2 col-12" />
          <a className="footer-descriptions" href="tel:(413)5325303">
            (413) 532-5303
          </a>
        </div>
        <div className="col-6 border-3 border-end px-1">
          <span className="fa fa-location my-auto p-2 col-12" />
          <a
        ...
        <div className="col-3 px-1">
          <span className="fa fa-envelope my-auto p-2 col-12" />
